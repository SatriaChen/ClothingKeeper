<template>
    <view class="content">
		...
		<view class="cu-form-group">
			...
			<input placeholder="(最少6位)" name="pwd" v-model="pwd" type="password"></input>
		</view>
		<view class="cu-form-group">
			<view class="title">确认密码</view>
			<input placeholder="再次输入密码" name="pwd2" v-model="pwd2" type="password"></input>
		</view>
			<view class="sex_wapper cu-form-group">
				<view class="flex1 boy" :class="sexIndex==2?'active':''" data-index="2" @click="checkSex">
					<view class="sex"></view>
					<view class="txt">男</view>
				</view>
				<view class="flex1 girls" :class="sexIndex==1?'active':''" data-index="1" @click="checkSex">
					<view class="sex"></view>
...
export default {
 ...
 methods: {
  register(){
  	...
  	if(this.pwd.length<=0||this.pwd2.length<=0){
  		uni.showToast({
  			icon:'none',
  			title:'请输入密码'
  		});
	...
	uni.request({
		url:'http://clothingkeeper.cn:8082/api/register',
		data:{
			uName:this.username, 
			uPassword:this.pwd,
			uGender:this.sexIndex,
		},
		header : {  
